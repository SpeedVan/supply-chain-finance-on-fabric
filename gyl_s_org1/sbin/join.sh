...
CORE_PEER_ID="GylSOrg1MSP" \
CORE_PEER_LOCALMSPID="GylSOrg1MSP" \
CORE_PEER_TLS_ENABLED="true" \
CORE_PEER_TLS_CERT_FILE=${CUR_DIR}/../cert/peerOrganizations/s1.supply.com/peers/peer0.s1.supply.com/tls/server.crt \
CORE_PEER_TLS_KEY_FILE=${CUR_DIR}/../cert/peerOrganizations/s1.supply.com/peers/peer0.s1.supply.com/tls/server.key \
CORE_PEER_TLS_ROOTCERT_FILE=${CUR_DIR}/../cert/peerOrganizations/s1.supply.com/peers/peer0.s1.supply.com/tls/ca.crt \
